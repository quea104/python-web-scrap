...
def main():
    ...
    select_sido = Select(driver.find_element(by=By.NAME, value='SIDO_NM0'))
    select_sigungu = Select(driver.find_element(by=By.NAME, value='SIGUNGU_NM0'))

    price_list_total = []

    for sido_index in range(1, len(select_sido.options)):
        select_sido = Select(driver.find_element(by=By.ID, value='SIDO_NM0'))
        select_sigungu = Select(driver.find_element(by=By.ID, value='SIGUNGU_NM0'))
